...
| compute.thresholds | object | `{"blameShare":0.4,"memStallSome":10,"refaultPerMin":1000,"runqP99Ms":20,"stallSome":20,"throttledRatio":0.25,"throttledRatioMax":0.1}` | Finding thresholds, evaluated by the broker over the last five minutes of history. Rendered into `COMPUTE_THRESHOLD_*` on the broker. |
